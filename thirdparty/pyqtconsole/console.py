...
from qtpy.QtWidgets import QPlainTextEdit, QApplication, QHBoxLayout, QWidget
...
class BaseConsole(QWidget):
    ...
    def __init__(self, parent=None, formats=None):
        ...
        self.edit = InputArea(parent)
        self.pbar = PromptArea(
            self.edit, self._get_prompt_text, PromptHighlighter(formats=formats))
        ...
        self.edit.setMinimumHeight(font_width * 40)
        # self.edit.setStyleSheet("background-color:rgb(30,30,30)")
        # self.pbar.setStyleSheet("background-color:rgb(100,0,0)")

        self.edit.setReadOnly(True)
        self.edit.setTextInteractionFlags(Qt.TextSelectableByMouse | Qt.TextSelectableByKeyboard)
